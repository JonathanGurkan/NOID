...
text_lines = [
    ...
    "Dive into an action-packed world where you explore mysterious dungeons,",
    ...
    "Upgrade System: Collect Power Cards to enhance your character’s Health,",
    "Stamina, Strength, and Defense. Each category features up to six",
    "upgrades, allowing for strategic customization.",
    "Challenging Gameplay: Plan your upgrades carefully—each Power Card",
    "can only be used for up to three or four upgrades.",
    ...
    "She has two swords and has the ability to attack and parry with the swords.",
    "She has a ton of attacks she can do and she looks really good.",
    "",
	"",
    ...
    "",
	"",
    "Every 3 or 4 rooms there will be a bossfight that the player needs to defeat to get a Power Card for an upgrade.",
    "Inspired by Legend of Zelda where every dungeon boss gives a Heart Container.",
    "",
	"",
    "Instead of a traditional level design, we went for a progressive room design.",
    "The player wakes up in his first dungeon and learns the basic movement, combat and parkour.",
    "We plan to make 10 rooms in total.",
    "",
	"",
    "You start in a dark cave, then move to a more open city environment after defeating the first boss.",
    "",
	"",
    "To maintain balance, enemies will give rewards based on difficulty.",
    "Rewards could be Slices of Power, coins, health, or stamina.",
    "Three Slices of Power = 1 Power Card.",
    "",
	"",
    "Upgrade Categories with Power Cards:",
    "Health: Increases survivability.",
    "Stamina: Improves endurance for dodging or running.",
    ...
    "Stay tuned for updates, new features, improvements, and bug fixes.",
    "We are planning to finish a playable version of the game on February 7th and",
	"the first chapter on March 6th.",
    "After the deadline, NOID will continue as a hobby project.",
	"",
	"",
	"",
	"If you this was hard to read, please visit our GitHub page for a more detailed README.",
